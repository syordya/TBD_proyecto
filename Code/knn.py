...
# # Se usa KNN para la clasificación de actividades:

# # Sensor localizado en la cintura:

# # Lectura de datos entrenados
...
# Programando la matriz de confusión

cm = confusion_matrix(target_label_wrist_test, predicted, labels=activities)
np.set_printoptions(precision=2)

#imprime matriz de confusion sin normalizar
#imprime matriz de confusion normalizada
#plotear la figura plt.figure(figsize=(10,10))
#poltear la cm  plot_confusion_matrix(cm)
#Normalizar la matriz de confusion por filas
...
# Lectura de los 33 tipos de archivos
...
# imprimir data entrenada de la cintura
...
# imprimir datos entrenados del brazo superior
...
# Imprimir datos testeados de cadera
...
#Imprimir datos testeados del tobillo
