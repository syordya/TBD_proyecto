...
def main():
    ...
    for site in sites:
        ...
        for subgroup in l:
            ...
            sub = sub + 1
            test_site_fileObj = (testfileObj.loc[testfileObj['Ubicacion del Sensor'] == site])
            ...
            if X_test.shape[0] != 0:
                ...
                for file in subgroup:
                    ...
                    site_fileObj = (fileObj.loc[fileObj['Ubicacion del Sensor'] == site])
                    y_cur = site_fileObj[['Actividad']].values.ravel()
